...
class SQFA(nn.Module):
    ...
    def __init__(self, input_covariances, feature_noise=0, n_filters=2, filters=None, constraint='sphere'):
        """
        Initialize SQFA.
        ...
        input_covariances : torch.Tensor
            Covariance matrices of the input data for each class, of shape (n_classes, n_dim, n_dim).
        feature_noise : float
